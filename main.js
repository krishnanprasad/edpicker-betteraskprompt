...
// This file intentionally avoids TypeScript/Angular dependencies so the page can render without a build step.
    ...
    <div class="max-w-3xl mx-auto p-8">
      ...
      <div class="bg-white shadow rounded p-6">
        ...
        <ul class="list-disc pl-5 text-gray-700">
          ...
          <li>Alternatively, I can add a GitHub Actions workflow to build and deploy the Angular app automatically (set up Node.js, install, build, and deploy to Pages). Tell me if you want that.</li>
        </ul>
      </div>
    </div>
  `;
